    ...
    <div class="d-flex flex-nowrap" style="min-height: 100vh;">
        ...
        <div id="sidebar" class="bg-dark text-white d-flex flex-column flex-shrink-0 shadow-lg">
            ...
            <div class="sidebar-menu flex-grow-1 py-3 overflow-auto">
                <a href="<?= base_url('penghuni/dashboard') ?>" class="<?= uri_string() == 'penghuni/dashboard' ? 'active' : '' ?>"><i class="bi bi-speedometer2 me-2"></i> Dashboard</a>
                
                <div class="px-4 mt-4 mb-2 text-uppercase text-muted small fw-bold">Menu Utama</div>
